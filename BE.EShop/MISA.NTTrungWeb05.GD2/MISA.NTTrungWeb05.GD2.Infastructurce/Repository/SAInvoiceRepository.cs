...
{
    public class SAInvoiceRepository : CodeRepository<SAInvoice, SAInvoiceModel>, ISAInvoiceRepository
    {
        public SAInvoiceRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
    }
}
