...
{
    public class ItemCategoryExcelService : ExcelService<ItemCategoryModel, ItemCategory>, IItemCategoryExcelService
    {
        public ItemCategoryExcelService(IItemCategoryRepository itemCategoryRepository) : base(itemCategoryRepository)
        {
        }
    }
}
