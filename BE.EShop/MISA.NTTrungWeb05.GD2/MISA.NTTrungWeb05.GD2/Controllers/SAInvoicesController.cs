...
namespace MISA.NTTrungWeb05.GD2.Controllers
{
    ...
    [ApiController]
    public class SAInvoicesController : CodeController<SAInvoiceDTO, SAInvoiceDTO, SAInvoiceModel>
    {
        #region Field
        #endregion
        public SAInvoicesController(ISAInvoiceService iSAInvoiceService) : base(iSAInvoiceService)
        {
        }
    }
}
